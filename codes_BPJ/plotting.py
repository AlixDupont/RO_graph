...
# ax1.plot(log_PR015, log_Ind, '.', markersize='2', label="degré entrant")
# ax1.set_xscale('log')
# ax1.set_yscale('log')
# ax1.legend(loc='upper center')

# ax2.plot(log_PR015, log_Outd, '.', markersize='2', label="degré sortant")
# ax2.set_xscale('log')
# ax2.set_yscale('log')
# ax2.legend(loc='upper center')

# ax3.plot(log_PR015, log_PR010, '.', markersize='2', label="PageRank de 0.10")
# ax3.set_xscale('log')
# ax3.set_yscale('log')
# ax3.legend(loc='upper center')

# ax4.plot(log_PR015, log_PR020, '.', markersize='2', label="PageRank de 0.20")
# ax4.set_xscale('log')
# ax4.set_yscale('log')
# ax4.legend(loc='lower center')

# ax5.plot(log_PR015, log_PR050, '.', markersize='2', label="PageRank de 0.50")
# ax5.set_xscale('log')
# ax5.set_yscale('log')
# ax5.legend(loc='lower center')

# ax6.plot(log_PR015, log_PR090, '.', markersize='2', label="PageRank de 0.90")
# ax6.set_xscale('log')
# ax6.set_yscale('log')
...
# plt.show()
# time.sleep(10)
plt.savefig("plots_ex_2_logvalues.png", bbox_inches='tight')
